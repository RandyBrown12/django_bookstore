...
with open(os.path.join(BASE_DIR, 'psql_info.json'), 'r') as file:
    psql_info = json.load(file)

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-*sg16=m^43ip7gb!(iyr=ld*wr&$sc^2&6u2!tyl_v@g=)-naj'
...
DATABASES = {
    'default': {
        ...
        'NAME': psql_info.get('database', None),
...
# Convert an HTTP to HTTPS. Uncomment to do that
"""
